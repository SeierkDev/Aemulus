    ...
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 pt-8">
      ...
      <div className="mt-6 rounded-lg border border-border p-5">
        <div className="flex items-baseline justify-between">
          <span className="text-sm text-ink-3">$AEMU tier</span>
          <span className="text-lg font-semibold tracking-tight">{viewer.tier}</span>
        </div>
        <div className="mt-4">
      ...
      {ent.limit == null ? (
        ...
        <div className="mt-6">
          <p className="mb-3 text-sm text-ink-2">
            Hold more $AEMU to reach a higher tier and remove the monthly limit.
            {ent.enforced && !ent.canEnter && " You’ve reached this tier’s limit."}
          </p>
