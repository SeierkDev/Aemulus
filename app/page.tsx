...
const DIFFERENTIATORS = [
  [
    "Knows when to stop",
    "Every step carries a confidence score. The cases it isn't sure about get flagged for you — never guessed.",
  ],
  [
    "Brings receipts",
    "Each step is captured with a screenshot. You see exactly what happened, in order. Trust by proof, not faith.",
  ],
  [
    "Survives UI changes",
    "It understands the intent of each step, so when a layout shifts it adapts — where recorded macros simply break.",
  ],
];
